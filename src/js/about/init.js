...
function groupsFn(groupsLen){
    var imgNum, grps, list, cls, imgs, num=0;
    var custNum = 42,
    ...
    for(var y = 0 ; y < groupsLen ; y ++){
        ...
        for( var i = 0 ; i < list.length ; i++ ){
            if( (i+1) <= imgNum ){
                ...
                imgs = '<div class="list-img"><figure><img src="http://img.withutour.co.kr/renew/about/img_'+grps+'_logo_'+num+'.png" alt="'+list[i]+'"></figure></div>';
                cls = '';
            }else{
                imgs = '';
                cls = 'type-2'
            ...
            $('.sect-groups .area-groups.'+grps+' .list-groups').append('<li><div class="area-list '+cls+'"><div class="box-list">'+imgs+'<p class="txt-list"><span>'+list[i]+'</span></p></div></div></li>');
        }
    }
